...
import '../shared/returned_data_from_contact_us.dart';
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    txt('feedback or suggestion would',
                      Colors.white, 15,
                    ),
                    txt(' be appreciated',
                      Colors.white, 15,
...
margin: EdgeInsets.only(top: 30),
    ...
    child: SingleChildScrollView(
      ...
      MaterialButton(
        ...
        color: green_color,
        child: txt('send', Colors.white, 20),
          onPressed: (){

Navigator.of(context).push(
  MaterialPageRoute(builder: (v){
    return  returnDataContactUs(name: _name.text,email: _email.text,message: _message.text,);
  })
);
          }
